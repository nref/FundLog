...
public class EchoStream : Stream
{
  ...
  public bool DataAvailable => _Buffers.Count > 0;
  ...
  // we override the xxxxAsync functions because the default base class shares state between ReadAsync and WriteAsync,
  // which causes a hang if both are called at once
